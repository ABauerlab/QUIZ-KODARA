-- =============================================================
-- Kodara Private Label | parte 4
-- UTM de origem do lead (pra saber qual anuncio trouxe o contato depois
-- que o trafego pago comecar a apontar pro quiz).
--
-- Rode DEPOIS de schema.sql, 02-frete-e-recuperacao.sql e
-- 03-modelagem-tecido-kit-marca.sql, uma vez, no SQL Editor.
...
begin
  ...
  on conflict (session_id) do update set
    ...
    -- UTM so grava na CRIACAO do lead (primeira resposta da sessao): a origem
    -- de quem clicou no anuncio nao pode ser substituida por um valor vazio
    -- em resposta seguinte, nem sobrescrita se o navegador mandar de novo.
